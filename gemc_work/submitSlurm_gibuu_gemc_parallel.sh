...
gemc "\$GCARD" -RUNNO="\$RUNNO" -USE_GUI=0 -N=10000 -SKIPNGEN=0 -INPUT_GEN_FILE="LUND, \$LUNDFILE" -OUTPUT="hipo,gemc_gibuu_part0.hipo" > gemc_part0.log 2>&1 &

PID0=\$!

cd ../gemc_part1_work

gemc "\$GCARD" -RUNNO="\$RUNNO" -USE_GUI=0 -N=20000 -SKIPNGEN=10000 -INPUT_GEN_FILE="LUND, \$LUNDFILE" -OUTPUT="hipo,gemc_gibuu_part1.hipo" > gemc_part1.log 2>&1 &
...
hipo-utils -merge -o gemc_gibuu_OutFile.hipo gemc_part0_work/gemc_gibuu_part0.hipo gemc_part1_work/gemc_gibuu_part1.hipo
